...
/**
 * Benchmark for {@link StackObjectPool}
 */
public class StackObjectPoolBenchmark extends ObjectPoolBenchmark<TestObject> {

    private StackObjectPool<TestObject> objectPool;
