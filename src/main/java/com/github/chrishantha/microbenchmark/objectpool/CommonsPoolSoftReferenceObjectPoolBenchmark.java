...
/**
 * Benchmark for {@link SoftReferenceObjectPool} in Apache Commons Pool1
 */
public class CommonsPoolSoftReferenceObjectPoolBenchmark extends ObjectPoolBenchmark<TestObject> {
